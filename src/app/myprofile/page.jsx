...
function InnerComponent() {
  ...
  const getInfos = async e => {
    await axios.get(`${spotifyUrl}/me`, { headers: { Authorization: `Bearer ${access}` } })
      .then(e => {
        console.log(e.data);
        setinfos(e.data);
        getMyFollowings();
  ...
  const getMyFollowings = async e => {
    await axios.get(`${spotifyUrl}/me/following?type=artist&limit=5`, { headers: { Authorization: `Bearer ${access}` } })
      .then(e => {
